...
describe('Sudoku Solver', function() {
 ...
 //  	it('should save all empty positions, 0, in ap arsed board', function(){
 ...
 //  	it('should check that each value in a row does not match the input', function(){
 ...
 //  	it('should check each that each value in a column does not match input', function(){
 //  		// no match. return true
 ...
 //  	it('should check each value in a 3x3 does not match input', function() {
 //  		// no match. return true
 ...
 //  	it('should find a solution to the puzzle', function(){
